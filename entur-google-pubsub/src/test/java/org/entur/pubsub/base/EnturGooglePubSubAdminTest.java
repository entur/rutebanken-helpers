...
class EnturGooglePubSubAdminTest extends BasePubSubIntegrationTest {
    ...
    public static final Set<String> TEST_SUBSCRIPTIONS = Set.of("test-subscription-1", "test-subscription-2");
    ...
    void testCreateSubscriptionIfMissing() {
        TEST_SUBSCRIPTIONS.forEach(s -> enturGooglePubSubAdmin.createSubscriptionIfMissing(s));
        Set<String> createdSubscriptions = pubSubAdmin.listSubscriptions()
                .stream()
