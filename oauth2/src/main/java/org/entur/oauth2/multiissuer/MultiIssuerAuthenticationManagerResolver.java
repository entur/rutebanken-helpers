...
public class MultiIssuerAuthenticationManagerResolver
    ...
    private JwtDecoder jwtDecoder(String issuer) {
        if (StringUtils.hasText(enturInternalAuth0Issuer) && enturInternalAuth0Issuer.equals(issuer)) {
            return enturInternalAuth0JwtDecoder();
        } else if (StringUtils.hasText(enturPartnerAuth0Issuer) && enturPartnerAuth0Issuer.equals(issuer)) {
            return enturPartnerAuth0JwtDecoder();
        } else if (StringUtils.hasText(rorAuth0Issuer) && rorAuth0Issuer.equals(issuer)) {
