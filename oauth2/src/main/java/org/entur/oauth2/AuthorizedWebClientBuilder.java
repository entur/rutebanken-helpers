...
public class AuthorizedWebClientBuilder {
    ...
    public AuthorizedWebClientBuilder withClientRegistrationId(String clientRegistrationId) {
    ...
    private ServerOAuth2AuthorizedClientExchangeFilterFunction serverOAuth2AuthorizedClientExchangeFilterFunction() {
        ...
        serverOAuth2AuthorizedClientExchangeFilterFunction.setDefaultClientRegistrationId(clientRegistrationId);
