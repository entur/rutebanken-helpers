...
class AuthorizedClientServiceReactiveOAuth2AuthorizedClientManagerBuilder {
  ...
  public AuthorizedClientServiceReactiveOAuth2AuthorizedClientManagerBuilder withOAuth2ClientProperties(
  ...
  public AuthorizedClientServiceReactiveOAuth2AuthorizedClientManagerBuilder withAudience(
    String audience
  ) {
