 ...
 */
public class RorAuth0RolesClaimAdapter
  ...
  public Map<String, Object> convert(Map<String, Object> claims) {
    ...
    Object roleAssignments = convertedClaims.get(
      rorAuth0ClaimNamespace + "role_assignments"
    );
    ...
    Object preferredName = convertedClaims.get(
      rorAuth0ClaimNamespace + StandardClaimNames.PREFERRED_USERNAME
    );
