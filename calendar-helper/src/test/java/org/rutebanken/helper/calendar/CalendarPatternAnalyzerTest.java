...
class CalendarPatternAnalyzerTest {
  ...
  void testParseFromStringEmptyPattern() {
    Set<DayOfWeek> significantDays = analyzer.computeSignificantDays(
      calStartDate,
      includedDaysAsBoolArray(emptyPattern)
    );
  ...
  void testParseFromStringSundayPattern() {
    Set<DayOfWeek> significantDays = analyzer.computeSignificantDays(
      calStartDate,
      includedDaysAsBoolArray(sundayPattern)
    );
  ...
  void testParseFromStringSaturdayPattern() {
    Set<DayOfWeek> significantDays = analyzer.computeSignificantDays(
      calStartDate,
      includedDaysAsBoolArray(saturdayPattern)
    );
  ...
  void testParseFromStringFridayPattern() {
    Set<DayOfWeek> significantDays = analyzer.computeSignificantDays(
      calStartDate,
      includedDaysAsBoolArray(fridayPattern)
    );
  ...
  void testParseFromStringWednesdayPattern() {
    Set<DayOfWeek> significantDays = analyzer.computeSignificantDays(
      calStartDate,
      includedDaysAsBoolArray(wednesdayPattern)
    );
  ...
  void testFromStringSingleDayPattern() {
    Set<DayOfWeek> significantDays = analyzer.computeSignificantDays(
      calStartDate,
      includedDaysAsBoolArray(noPattern)
    );
    Assertions.assertTrue(significantDays.isEmpty());
  }
  ...
  void testParseFromStringTuesdayToFridayPattern() {
    Set<DayOfWeek> significantDays = analyzer.computeSignificantDays(
      calStartDate,
      includedDaysAsBoolArray(tuesdayToFridayPattern)
    );
  ...
  void testComputeCalendarPatternEmptyPattern() {
    CalendarPattern pattern = analyzer.computeCalendarPattern(
      includedDaysAsLocalDates(calStartDate, emptyPattern)
    );
  ...
  void testComputeCalendarPatternSundayPattern() {
    CalendarPattern pattern = analyzer.computeCalendarPattern(
      includedDaysAsLocalDates(calStartDate, sundayPattern)
    );
  ...
  void testComputeCalendarPatternSaturdayPattern() {
    CalendarPattern pattern = analyzer.computeCalendarPattern(
      includedDaysAsLocalDates(calStartDate, saturdayPattern)
    );
    Assertions.assertEquals(
      pattern.significantDays,
  ...
  void testComputeCalendarPatternFridayPattern() {
    CalendarPattern pattern = analyzer.computeCalendarPattern(
      includedDaysAsLocalDates(calStartDate, fridayPattern)
    );
  ...
  void testComputeCalendarPatternWednesdayPattern() {
    CalendarPattern pattern = analyzer.computeCalendarPattern(
      includedDaysAsLocalDates(calStartDate, wednesdayPattern)
    );
    Assertions.assertEquals(
      pattern.significantDays,
  ...
  void testComputeCalendarPatternNoPattern() {
    CalendarPattern pattern = analyzer.computeCalendarPattern(
      includedDaysAsLocalDates(calStartDate, noPattern)
    );
    Assertions.assertNull(pattern);
  }
  ...
  void testComputeCalendarPatternTuesdayToFridayPattern() {
    CalendarPattern pattern = analyzer.computeCalendarPattern(
      includedDaysAsLocalDates(calStartDate, tuesdayToFridayPattern)
    );
    Assertions.assertEquals(
      pattern.significantDays,
      Set.of(
    ...
    Assertions.assertEquals(
      ...
      Set.of(
        calStartDate.plusDays(64),
        calStartDate.plusDays(65),
        calStartDate.plusDays(66),
        calStartDate.plusDays(67),
        calStartDate.plusDays(108),
        calStartDate.plusDays(120)
      )
    );
    Assertions.assertEquals(
      pattern.additionalDates,
      Set.of(calStartDate.plusDays(6), calStartDate.plusDays(343))
    );
  }
  ...
  void testComputeCalendarPatternEveryDayPattern() {
    CalendarPattern pattern = analyzer.computeCalendarPattern(
      includedDaysAsLocalDates(calStartDate, everyDayPattern)
    );
  ...
  private Set<LocalDate> includedDaysAsLocalDates(
    LocalDate startDate,
    String includedArray
  ) {
